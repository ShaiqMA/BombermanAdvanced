...
public class Texture
{
  ...
  public static Texture LoadFromFile(string path, bool smooth)
  {
    // Generate handle
    ...
    if( !File.Exists(path))
    {
      throw new FileNotFoundException($"Could not find texture file \"{path}\", did you include it in your project? Is the file copied to the output folder?", path);
    }
